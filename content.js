...
const fetchResponse = async (prompt) => {
    ...
    const payload = {
        contents: [
            {
                role: "user",
                parts: [{ text: "You are an assistant, that writes replies to LinkedIn posts. Use the same language as the incoming post. Sound human. Don't repeat too many exact words. Create a brief, positive reply and maybe add something to the discussion. Be creative! Mention the author's name if it's a person." }]
            },
            {
                role: "user",
                parts: [{ text: prompt }]
